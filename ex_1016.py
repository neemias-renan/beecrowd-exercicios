...
# Em uma hora (60 minutos) o carro Y consegue 
# se distanciar 30 quilômetros do carro X, ou seja,
# consegue se afastar um quilômetro a cada 2 minutos.
# Leia a distância (em Km) 
# e calcule quanto tempo leva (em minutos)
# para o carro Y tomar essa distância do outro carro.


distancia = int(input())
print(str(distancia*2)+" minutos")