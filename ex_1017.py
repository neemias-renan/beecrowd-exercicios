# Joaozinho quer calcular 
# e mostrar a quantidade de litros de combustível gastos em uma viagem,
# ao utilizar um automóvel que faz 12 KM/L.
# Para isso, ele gostaria que você o auxiliasse através de um 
# simples programa. Para efetuar o cálculo, 
...
consumomedio = distanciapercorrida/12
print("%.3f"%consumomedio)